...
export const DISPLAY_SET_DEVICE = 'DISPLAY_SET_DEVICE';
...
export type SetDeviceAction = {
  type: typeof DISPLAY_SET_DEVICE;
  device: Devices;
};
...
export const setDevice = (device: Devices): SetDeviceAction => ({
  type: DISPLAY_SET_DEVICE,
  device,
});
